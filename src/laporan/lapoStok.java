 ...
 * @author aldia
 */
public class lapoStok extends javax.swing.JFrame {
    ...
    public void lapJual(){
            ...
            String sql = "Select * From stok, barang, kategori_barang "
                    + "where stok.barang_id = barang.barang_id AND barang.kategori_id = kategori_barang.kategori_id "
                    + "order by nama_kategori asc";
            ResultSet rs = st.executeQuery(sql);
            while(rs.next()){
                Object[] obj = new Object[4];
                obj[0] = rs.getString("stok.barang_id");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lapoStok.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
